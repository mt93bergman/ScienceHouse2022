...
# -*- coding: utf-8 -*-
"""
Created on Sat Jun 11 12:25:23 2022
...
# def check_overlap(ps, num_particles):
...
#             rij = i_loc- j_loc
#             dist = np.dot(rij, rij)
#             if 4*R*R - dist > 0.1 and agg_indices[i] != agg_indices[j]:
#                 print('overlap!')
...
simulate(seed=10, num_particles=400)
